  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/land.png);">
				<div class="desc">
					<div class="container">
						<div class="row">
...
keberangkatan tour yang telah di booking. Biaya yang telah ditranfer 
...
<li>Silahkan melakukan transfer ke bank BNI, No REK : 0707217296, Atas nama Ridho Pramono</li>
...
<?php endforeach; ?>
								...
								<div class="col-md-6">
									<label>Asal Daerah Keberangkatan</label>
									<div class="form-group">
...
<?php endforeach; ?>
								...
								<div class="col-md-6">
										<div class="input-field">
													<label for="date-start">Tgl Keberangkatan</label>
