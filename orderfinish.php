...
if(isset($_SESSION['id_user'])){
    ...
    // get the HTML
    ob_start();	
	$comot=$_mysqli->query("SELECT * FROM tbl_pesan, tbl_daerah, tbl_paket, tbl_hotel, tbl_user WHERE tbl_pesan.id_user=tbl_user.id_user AND
						tbl_pesan.id_paket=tbl_paket.id_paket AND tbl_pesan.id_daerah=tbl_daerah.id_daerah AND id_pesan=".$_GET['id']);
	$isi_tbl=mysqli_fetch_array($comot);
	
	$total_harga   =$isi_tbl['harga_paket']+$isi_tbl['biaya'];
            ...
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 34mm;position: relative;font-size: 5mm;">
                    ...
                    <div style="position: absolute; right: 3mm; bottom: 3mm; text-align: right; font-size: 4mm; ">
                        ...
                        kode Pemesanan: <b><?php echo $num; ?></b><br>
                        Tanggal Tour : <b><?php echo $isi_tbl['tgl_tour']; ?></b><br>
                    </div>
                    <img src="images/be.png" width="100" height="99" />
					<span style="position: absolute; left: 32mm; top: 10mm; font-size: 28px; color: red">Sarjana Tour & Travel</span><br />
                    <span style="position: absolute; left: 32mm; top: 18mm; font-size: 16px;">Yogyakarta, <?php echo $date; ?></span>
        ...
        <tr>
            ...
            <td style="width: 75%">
                <div class="zone" style="height: 40mm;vertical-align: middle; text-align: justify">
                    <b>Ketentuan :</b><br>
					1. Perubahan Peket  silahkan hubungi contact person kami yang ada pada website, dan hanya bisa dilakukan 5 hari sebelum hari keberangkatan tour. Kurang dari itu perubahan tidak bisa dilakukan.<br>
