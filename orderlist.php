		...
		<div class="table-responsive">
				<table class="table table-bordered table-striped table-hover">
                 ...
                 $id_user=$_SESSION['id_user'];
						...
						$comot=$_mysqli->query("select *from tbl_pesan,tbl_user,tbl_daerah,tbl_paket where tbl_pesan.id_user=tbl_user.id_user and tbl_pesan.id_paket=tbl_paket.id_paket and tbl_pesan.id_daerah=tbl_daerah.id_daerah and tbl_user.id_user='$id_user'");
