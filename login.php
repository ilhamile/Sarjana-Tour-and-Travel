				...
				<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<p>Perusahaan kami bergerak di bidang penyewaan jasa tour and travel. kami melayani untuk melakukan tour di wilayah Yogyakarta.</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Jl imogiri timur no 141, Umbulharjo, kota Yogyakarta</li>
								<li><i class="icon-phone2"></i>082144196423</li>
								<li><i class="icon-mail"></i><a href="#">Sarjanatravel2019@gmail.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">www.sarjanatravel.com</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
